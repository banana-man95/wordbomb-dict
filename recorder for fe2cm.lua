...
Alert("Activated neutron bomb!!!!"..RunID, Color3.new(0.717647, 0, 1))
...
local function SaveRun()
    ...
    -- ending line
    local mapName = workspace.Multiplayer.Map.Settings:GetAttribute("MapName")
    local AllPlayerInfo = minfile(AllPlayerInfo)
    writefile("CM_TAS/"..mapName..".json", game:GetService("HttpService"):JSONEncode(AllPlayerInfo))
